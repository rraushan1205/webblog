...
const ManagePostPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setFilteredPosts(results.map((r) => r.item));
  }, [searchQuery, posts]);
  ...
  return (
    <div className="flex flex-col my-10">
      ...
      <table className="max-w-ft border h-fit border-gray-800 border-collapse mx-24 my-10">
        ...
        <tbody>
          {filteredPosts.map((post) => (
            <tr key={post.id}>
              ...
              <td className="border border-gray-400 px-4 py-2 truncate">
                {post.content}
              </td>
